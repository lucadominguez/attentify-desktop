    ...
    <div className="p-4 animate-fade-in space-y-3 overflow-y-auto h-full">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-navy-500 text-[10px] mt-0.5">Weekly attention leak report</p>
        </div>
      ...
      >
        ...
        <div className="flex-1 rounded-full overflow-hidden h-2" style={{ background: 'rgba(30,58,95,0.5)' }}>
          {totalTracked > 0 ? (
            <>
              <div
        ...
        <span className="text-[10px] text-navy-600 flex-shrink-0 tabular-nums">{Math.round(focusRatio)}% focused</span>
      </div>

      {/* Daily stacked bar chart */}
      <div className="rounded-xl p-3" style={{ background: '#0d1b2a', border: '1px solid rgba(30,58,95,0.5)' }}>
        <p className="text-white text-[11px] font-semibold mb-3">Daily Breakdown — Last 7 Days</p>
        {dailyData.every((d) => d.focused === 0 && d.distracted === 0) ? (
          <p className="text-navy-700 text-[10px] text-center py-4">No data yet — activity tracker populates over time</p>
        ) : (
                ...
                >
                  <div className="w-full rounded-sm overflow-hidden flex flex-col-reverse" style={{ height: h }}>
                    {total > 0 ? (
                      ...
                      <div className="flex-1" style={{ background: 'rgba(30,58,95,0.25)' }} />
                    )}
                  </div>
        ...
        <div className="flex items-center gap-4 mt-2">
          <span className="flex items-center gap-1 text-[9px] text-navy-600">
      ...
      <div className="rounded-xl p-3" style={{ background: '#0d1b2a', border: '1px solid rgba(30,58,95,0.5)' }}>
        <p className="text-white text-[11px] font-semibold mb-3">Top Attention Drains</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-1.5 w-28 flex-shrink-0">
                    ...
                    <span className="text-white text-[11px] font-medium truncate">{app}</span>
                  </div>
                  <div className="flex-1 rounded-full overflow-hidden h-1.5" style={{ background: 'rgba(30,58,95,0.5)' }}>
                    <div
                  ...
                  <span className="text-navy-500 text-[10px] font-mono tabular-nums w-10 text-right flex-shrink-0">{fmt(ms)}</span>
                </div>
              )
            })}
          </div>
